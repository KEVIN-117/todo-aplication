                ...
                <div className="relative p-4 w-full max-w-md h-full md:h-auto">
                    ...
                    <div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                        ...
                        <div className="w-12 h-12 rounded-full bg-green-100 dark:bg-red-900 p-2 flex items-center justify-center mx-auto mb-3.5">
                            <svg className="w-6 h-6 text-red-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                        ...
                        <p className="mb-4 text-lg font-semibold text-gray-900 dark:text-white">
                            Error en el registro de un nuevo todo
                        </p>
                        <button
                            data-modal-toggle="successModal"
                            type="button"
